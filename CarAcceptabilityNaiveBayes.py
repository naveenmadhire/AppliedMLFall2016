...
sys.path.append("Spark Python directory")
...
(trainingData, testData) = newDfInputData.randomSplit([0.70, 0.3])

trainingData.show()

# Train the model using Naive Bayes algorithm
dt = NaiveBayes(labelCol="indexedacceptance", featuresCol="features", smoothing=2)
